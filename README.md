...
This project is now a **React + TypeScript frontend** integrated with a **Flask backend** that proxies chat requests to Ollama.

## What was fixed

- Frontend now sends real `/chat` requests to backend (not placeholder-only content).
